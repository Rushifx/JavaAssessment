...
public class Main
{
        ...
        do
        {
            ...
            switch ( option )
            {
                ...
                case 5:
                    ...
                    break;
                case 7:
                    displayAverageGradeForCourse(studentService, scanner);
                    break;
            }
        } while (option != 8);
    }

    private static void displayAverageGradeForCourse(StudentService studentService, Scanner scanner) {
        System.out.println("Please enter course ID to display average grade: ");
        String courseId = scanner.next();
        studentService.displayAverageGrade(courseId);
    }
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        String courseId = scanner.next();
        if (!student.isAttending(courseId)) {
